...
count = 0
while count < 5:
    print(cou# Loops in Python (for and while)
...
In this example, the "while" loop continues to execute as long as the "count" is less than 5. The "count" variable is incremented in each iteration.nt)
    count += 1
```
